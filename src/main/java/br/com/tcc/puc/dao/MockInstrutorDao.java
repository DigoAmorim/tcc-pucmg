...
public class MockInstrutorDao implements CrudDao<Instrutor> {
	...
	/**
	 * Método que adicionar um instrutor passado como parâmetro a uma lista de instrutores.
	 */
	...
	private void popularInstrutores() {
		...
		i.setTpAtividade(new String[] {"Aulas em grupo","Musculação"});
		instrutores.add(i);
		i = new Instrutor();
		i.setNome("João da Silva");
		i.setCpf("443.105.365-15");
		i.setRg("582.200.40-63");
		i.setTpAtividade(new String[] {"Aulas em grupo"});
		instrutores.add(i);
		i = new Instrutor();
